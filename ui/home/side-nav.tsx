// Updated SideNav component with sticky positioning
...
export async function SideNav({ categories }: { categories: Categories[] | undefined }) {
    ...
    return (
        <div className="hidden lg:flex lg:max-w-[250px] flex-col justify-between flex-[0.55] mr-6 p-4 border-[1px] border-gray-300 text-black text-opacity-60 text-base rounded-md min-w-[250px]">
            <div>
